 ...
 */
public class OptimizeUdfUtil {

    public static boolean isOptimizeUdf(String columnName) {
        if (columnName.contains(OptimizeConstant.COUNT) || columnName.contains(OptimizeConstant.COUNT_DISTINCT)) {
            return true;
        } else {
            return false;
        }
