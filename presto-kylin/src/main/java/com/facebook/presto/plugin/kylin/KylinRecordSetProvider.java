...
public class KylinRecordSetProvider extends JdbcRecordSetProvider {

    private final JdbcClient jdbcClient;

    @Inject
    public KylinRecordSetProvider(JdbcClient jdbcClient) {
        super(jdbcClient);
    ...
    public RecordSet getRecordSet(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorSplit split, List<? extends ColumnHandle> columns) {
        ...
        return new KylinRecordSet(this.jdbcClient, session, jdbcSplit, handles.build());
    }
}
