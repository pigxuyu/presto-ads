...
public class KylinRecordCursor implements RecordCursor {
    ...
    public KylinRecordCursor(JdbcClient jdbcClient, ConnectorSession session, JdbcSplit split, List<JdbcColumnHandle> columnHandles) {
        ...
        try {
            ...
            statement = ((KylinClient) jdbcClient).buildSql(connection, split, columnHandles, session.getQueryId());
