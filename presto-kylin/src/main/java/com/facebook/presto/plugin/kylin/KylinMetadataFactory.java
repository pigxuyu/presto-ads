 ...
 */
public class KylinMetadataFactory extends JdbcMetadataFactory {

    private final JdbcClient jdbcClient;

    @Inject
    public KylinMetadataFactory(JdbcClient jdbcClient, JdbcMetadataConfig config) {
    ...
    public JdbcMetadata create() {
        return new KylinMetadata(jdbcClient, false);
    }
}