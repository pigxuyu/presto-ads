 ...
 */
public class DruidMetadataFactory extends JdbcMetadataFactory {

    private final JdbcClient jdbcClient;

    @Inject
    public DruidMetadataFactory(JdbcClient jdbcClient, JdbcMetadataConfig config) {
    ...
    public JdbcMetadata create() {
        return new DruidMetadata(jdbcClient, false);
    }
}