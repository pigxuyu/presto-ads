...
public class DruidRecordSetProvider extends JdbcRecordSetProvider {

    private final JdbcClient jdbcClient;

    @Inject
    public DruidRecordSetProvider(JdbcClient jdbcClient) {
        super(jdbcClient);
    ...
    public RecordSet getRecordSet(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorSplit split, List<? extends ColumnHandle> columns) {
        ...
        return new DruidRecordSet(this.jdbcClient, session, jdbcSplit, handles.build());
    }
}
